...
/**
 * Interface containing methods to make requests to the Multinationales Web Site.
 */
interface MultinationalesWebService {

    /**
     * Returns the article from the Multinationales Web Site.
     *
     * @param articleUrl the url of the article to get.
     *
     * @return the article from the Multinationales Web Site.
     */
    @GET("{articleUrl}")
    suspend fun getArticle(@Path("articleUrl") articleUrl: String): ResponseBody

    /**
     * Returns the category from the Multinationales Web Site.
     *
     * @param category the category to get articles list.
     * @param number the number of the first article on the page.
     *
     * @return the category from the Multinationales Web Site.
     */
    ...
    /**
     * Returns the css style from the Multinationales Web Site.
     *
     * @param cssUrl the url of the css to get.
     *
     * @return the css from the Multinationales Web Site.
     */
    @GET
