...
/**
 * Class test, for Bastamag Rss Service Interface, check that fetching data properly works.
 */
class BastamagRssServiceTest : KoinTest {

    // FOR DATA
    private val bastamagRssService = get<BastamagRssService>()

    @Test
    fun fetchRssArticles() = runBlocking {
        val rssResponse = bastamagRssService.getRssArticles()
